###Data Validation With Path and Query 
...
BOOKS = [
    ...
    Book(4 ,'HP1','Author 1' ,'Book Description',5,2009),
    Book(5,'HP2','Author 2' , 'Book Description',5,2027),
    Book(6,'HP3','Author 3','Book Description',5,2028)
...
async def create_book(book_request : BookRquest):
...
async def update_book(book: BookRquest):
